...
print("\n")
print("b")
print(b.is_valid_truth_table())
print("\n")
print("c")
print(c.is_valid_truth_table())
print("\n")
print("d")
print(d.is_valid_truth_table())
print("\n")
print("e")
print(e.is_valid_truth_table())
print("\n")
print("f")
print(f.is_valid_truth_table())
print("\n")
print("g")
print(g.is_valid_truth_table())
print("\n")
print("h")
print(h.is_valid_truth_table())
print("\n")
print("i")
print(i.is_valid_truth_table())
print("\n")
print("j")
print(j.is_valid_truth_table())
print("\n")
print("k")
print(k.is_valid_truth_table())
#
